		...
		<div>
				...
				<Container>
					<Row className='justify-content-center'>
						<Col md='7' className='text-center'>
							...
							<h6 className='subtitle'>
								You can relay on our amazing features list and also our customer services will be great experience for you without doubt and
								in no-time
							</h6>
						</Col>
					</Row>
						...
						<Col md='6' className='wrap-feature4-box'>
							<Card>
								<CardBody>
									...
									<p className='m-t-20'>
										You can relay on our amazing features list and also our customer services will be great experience. Lorem ipsum dolor
										sit amet, consectetur adipiscing elit. Praesent tristique pellentesque ipsum.
									</p>
									...
									<Col md='8'>
										<CardBody className='d-flex no-block'>
											<div className='m-r-20'>
												<Image src={img1} height='70' width='100' className='rounded' alt='img' />
											</div>
											<div>
							...
							<Card>
								<Row>
									<Col md='8'>
										<CardBody className='d-flex no-block'>
											<div className='m-r-20'>
												<Image src={img2} height='70' width='100' className='rounded' alt='img' />
											</div>
											<div>
												<h5 className='font-medium'>Make your website in no-time with us.</h5>
											</div>
							...
							<Card>
								<Row>
									<Col md='8'>
										<CardBody className='d-flex no-block'>
											<div className='m-r-20'>
												<Image src={img3} height='70' width='100' className='rounded' alt='img' />
											</div>
											<div>
												<h5 className='font-medium'>Make your website in no-time with us.</h5>
											</div>
							...
							<Card>
								<Row>
									<Col md='8'>
										<CardBody className='d-flex no-block'>
											<div className='m-r-20'>
												<Image src={img4} height='70' width='100' className='rounded' alt='img' />
											</div>
											<div>
												<h5 className='font-medium'>Make your website in no-time with us.</h5>
											</div>
			...
			<div className='spacer '>
				<Container className='feature30'>
					<Row>
						<Col lg='10'>
							<Image src={img5} className='rounded img-responsive' alt='wrappixel' />
						</Col>
							...
							<Card className='card-shadow'>
								<CardBody>
									<div className='p-20'>
										...
										<p>
											You can relay on our amazing features list and also our customer services will be great experience. You will love it
											for sure.
										</p>
