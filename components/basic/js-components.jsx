		...
		<div>
			...
			<Container>
				<Row className='m-b-40'>
					<Col md='6'>
						<Button type='button' onClick={toggle.bind(null)} className='btn btn-block waves-effect waves-light btn-outline-primary m-b-30'>
							Large Modal
						</Button>
						...
						<Button type='button' onClick={toggle2.bind(null)} className='btn btn-block waves-effect waves-light btn-outline-primary'>
							Small Modal
						</Button>
