					...
					<Navbar className='navbar-expand-lg h6-nav-bar'>
						...
						<Collapse isOpen={isOpen} navbar className='hover-dropdown ml-auto' id='h6-info'>
							<Nav navbar className='ml-auto'>
								<NavItem>
									<Link href='/'>
										<a className={router.pathname == '/' ? 'text-white nav-link' : 'nav-link'}>Custom Components</a>
									</Link>
								</NavItem>
								<NavItem>
									<Link href='/basic'>
										<a className={router.pathname == '/basic' ? 'text-white nav-link' : 'nav-link'}>Basic-Components</a>
									</Link>
								</NavItem>
							</Nav>
